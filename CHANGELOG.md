...
* feat: solverpy run/clean commands, fix log filename, document options [[details](https://github.com/cbboyan/solverpy/commit/) | [browse](https://github.com/cbboyan/solverpy/tree/)]
