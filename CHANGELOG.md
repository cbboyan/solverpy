...
* feat: bundle setup YAMLs in data/setups/, copy to cwd on solverpy init [[details](https://github.com/cbboyan/solverpy/commit/) | [browse](https://github.com/cbboyan/solverpy/tree/)]
