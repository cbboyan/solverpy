...
* feat: number legend entries (s1..sN), use refs in summary/statuses/bars [[details](https://github.com/cbboyan/solverpy/commit/) | [browse](https://github.com/cbboyan/solverpy/tree/)]
