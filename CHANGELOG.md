...
* feat: add Proofs plugin to extract and save TPTP proofs and premises [[details](https://github.com/cbboyan/solverpy/commit/) | [browse](https://github.com/cbboyan/solverpy/tree/)]
