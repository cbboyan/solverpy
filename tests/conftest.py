...
from solverpy.solver.smt.llm2smt import Llm2smt
...
LLM2SMT_NEQ = DATA / "llm2smt/NEQ016_size5.smt2"
...
SHELL_SOLVERS = [
   ...
   pytest.param(Llm2smt("T5"),                id="llm2smt"),
]
...
CASES = [
   ...
   pytest.param((Llm2smt("T5"),                LLM2SMT_NEQ,  "--preprocess-passes 1", "unsat"),   id="llm2smt-neq"),
]
