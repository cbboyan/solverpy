...
and decide how to surface them — as log messages ([`LogTalker`][solverpy.task.logtalker.LogTalker]),
progress bars ([`SolverTalker`][solverpy.task.solvertalker.SolverTalker]),
or forwarded across processes ([`RemoteTalker`][solverpy.task.remotetalker.RemoteTalker]).
...
class Talker:
   ...
   abstract class solverpy.task.logtalker.LogTalker extends solverpy.task.talker.Talker
   abstract class solverpy.task.remotetalker.RemoteTalker extends solverpy.task.talker.Talker
   ```
