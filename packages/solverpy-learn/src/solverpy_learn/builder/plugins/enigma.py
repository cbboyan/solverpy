...
from solverpy.solver.plugins.db.outputs import Outputs
...
class EnigmaTrains(SvmTrains):
   ...
   def __init__(
      ...
      self._ratio = ratio
      SvmTrains.__init__(self, dataname, chunk_size=chunk_size, features=features, variant=variant, ratio=ratio)
