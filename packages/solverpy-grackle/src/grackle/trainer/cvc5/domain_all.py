...
arith_brab {yes,no} [%(arith_brab)s]
arith_eq_solver {yes,no} [%(arith_eq_solver)s]
arith_no_partial_fun {yes,no} [%(arith_no_partial_fun)s]
arith_prop {none,unate,bi,both} [%(arith_prop)s]
arith_rewrite_equalities {yes,no} [%(arith_rewrite_equalities)s]
arith_static_learning {yes,no} [%(arith_static_learning)s]
collect_pivot_stats {yes,no} [%(collect_pivot_stats)s]
cut_all_bounded {yes,no} [%(cut_all_bounded)s]
dio_decomps {yes,no} [%(dio_decomps)s]
dio_solver {yes,no} [%(dio_solver)s]
error_selection_rule {min,varord,max,sum} [%(error_selection_rule)s]
fc_penalties {yes,no} [%(fc_penalties)s]
fp_exp {yes,no} [%(fp_exp)s]
fp_lazy_wb {yes,no} [%(fp_lazy_wb)s]
...
se_solve_int {yes,no} [%(se_solve_int)s]
soi_qe {yes,no} [%(soi_qe)s]
unate_lemmas {all,eqs,ineqs,none} [%(unate_lemmas)s]
use_approx {yes,no} [%(use_approx)s]
use_fcsimplex {yes,no} [%(use_fcsimplex)s]
use_soi {yes,no} [%(use_soi)s]
"""
...
DEFAULTS = {
   ...
   'arith_brab': 'yes',
   'arith_eq_solver': 'no',
   'arith_no_partial_fun': 'no',
   'arith_prop': 'both',
   'arith_rewrite_equalities': 'no',
   'arith_static_learning': 'yes',
   'collect_pivot_stats': 'no',
   'cut_all_bounded': 'no',
   'dio_decomps': 'no',
   'dio_solver': 'yes',
   'error_selection_rule': 'min',
   'fc_penalties': 'no',
   'fp_exp': 'no',
   'fp_lazy_wb': 'no',
